...
import Icon, { BellFilled, CoffeeOutlined, HomeOutlined, ShopOutlined, UserOutlined, WalletOutlined } from '@ant-design/icons';
        ...
        <div>
            <Layout style={{ minHeight: '100vh' }}>
                ...
                <Layout>
                    ...
                    <Footer style={{ textAlign: 'center' }}>Microservice Admin Dashboard</Footer>
                </Layout>
            </Layout>
        </div>
    );
